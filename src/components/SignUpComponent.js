          ...
          <Formik initialValues={{ email: '', password: '', confirmPassword: '' }}
            ...
            {props => (
              ...
              <SignUpForm>
                ...
                <ConfirmPasswordField name="confirmPassword" validate={this.validatePassword} type="password" />

                <ErrorMessage name="confirmPassword">
                  {error => <ErrorLabel>{error}</ErrorLabel>}
                </ErrorMessage>

                <SubmitButton type="submit" disabled={props.isSubmitting || !props.isValid} />
              </SignUpForm>
